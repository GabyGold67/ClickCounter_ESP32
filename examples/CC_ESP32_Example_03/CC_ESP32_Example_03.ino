 ...
 *       Last update:   09/07/2025 12:30 GMT+0200 DST  
 ******************************************************************************
...
void fnRlsdBttnRst(void *pvParameters);
void fnVddBttnRst(void *pvParameters);
...
void mainCtrlTsk(void *pvParameters){
   ...
   TmVdblMPBttn ssvmCntRst(ssvmCntRstPin, 3000, true, true, 20, 50);
   ...
   ssvmCntRst.setFVPPWhnTrnOff(fnRlsdBttnRst, &myClickCounter);
   ssvmCntRst.setFVPPWhnTrnOnVdd(fnVddBttnRst, &myClickCounter);
...
void fnPrssdBttnRst(void* pvParameters){
   ...
   myClickCounterPtr->blink(200);
   Serial.println("Button RESET pressed, waiting for preset time delay to execute count reset");
...
void fnRlsdBttnRst(void *pvParameters){
   ...
   myClickCounterPtr->noBlink();
   Serial.println("Button RESET released, ensuring blinking is stopped");
